...
def test_authenticate_user(test_user):
    ...
    authenticated_user = authenticate_user(username=test_user.username, password='testuser_password', db=db)
    assert authenticated_user is not None
    assert authenticated_user.username == test_user.username

    non_existent_user = authenticate_user(username='wrong_username', password='testuser_password', db=db)
